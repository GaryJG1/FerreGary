...
class AgregarUsuarioActivity : AppCompatActivity() {
    ...
    private val listaUsuarios = mutableListOf<usuarios.Producto>()
    ...
    private fun agregarUsuario() {
        ...
        if (nombre.isNotBlank() && apellido.isNotBlank() && correo.isNotBlank() && contrasena.isNotBlank()) {
            val nuevoUsuario = usuarios.Producto(0, nombre, apellido, correo, contrasena, telefono, direccion, tipoUsuario)
